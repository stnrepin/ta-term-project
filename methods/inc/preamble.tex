...
\setlist[enumerate,itemize]{nolistsep,topsep=-2mm,leftmargin=7mm}%,parsep=0.3cm}
...
\newcommand{\addanonimghere}[4]{ % Добавить рисунок непосредственно в это место
    \begin{figure}[H]
        \centering
        \includegraphics[width=#2\linewidth]{#1}
        \label{#4}
...
\newcommand{\anonsection}[1]{
    ...
    \paragraph{\normalfont\bfseries\centerline{{#1}}\vspace{1.5em}}
...
\hypersetup{
    ...
    pdfauthor={Репин Степан},
    pdftitle={Курсовая работа по ЭО}
}
